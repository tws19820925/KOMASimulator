...
- `assets/screenshots/input-overview-360dp.png`: 条件設定画面
- `assets/screenshots/field-overview-360dp.png`: 実釣画面
- `assets/screenshots/logs-overview-360dp.png`: 釣果ログ画面
- `assets/screenshots/settings-overview-360dp.png`: 設定画面
